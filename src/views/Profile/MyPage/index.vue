<template>
  <div class="container-fluid py-4" style="
    ...
    <div class="container">
      ...
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
          <div class="row align-items-center g-3">
            <div class="col-auto">
              <div v-if="mainPet" class="main-pet-card p-2 bg-white rounded shadow-sm"
                style="width: 170px; cursor: pointer" @click="openPetModal(mainPet)">
                <div class="ratio ratio-1x1 mb-2" style="overflow: hidden; border-radius: 8px">
                  <img :src="getPetImageUrl(mainPet)" alt="main pet"
              ...
              <div class="row g-3">
                <div class="col-lg-8">
                  ...
                  <div class="mt-2">
                    ...
                    <button v-if="isMyProfile" class="btn ms-2" :class="canOneOnOneGo ? 'btn-primary' : 'btn-outline-secondary'
                      " :disabled="!canOneOnOneGo" @click="openOneOnOneModal">
                      산책 하러가기!
                    </button>
                    <WalkRequest class="ms-2" v-if="!isMyProfile" :receive-user-id="Number(route.params.userId)" />
                  </div>
                </div>
      ...
      <!-- 스티커 보여주기 모달 -->
      <StickerWallModal v-model:show="showStickerModal" :user-id="routeUserId || store.state.user.userId" :max="20" />
          ...
          <div class="card border-0 shadow-sm mb-3">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <strong>필터</strong>
                <button class="btn btn-sm btn-outline-secondary" @click="resetFiltersAndReload">
                  초기화
                </button>
              </div>
              <div class="mb-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                  <div v-for="t in tags" :key="t.tagId" class="form-check">
                    ...
                    <label class="form-check-label small" :for="`tag-${t.tagId}`">{{ t.tagName }}</label>
                  </div>
                </div>
              </div>
