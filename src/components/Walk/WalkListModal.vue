    ...
    <div class="modal-card">
      ...
      <div class="modal-body">
        ...
        <ul class="nav nav-tabs mb-3">
          ...
          <li class="nav-item">
            <button class="nav-link" :class="{ active: tab === 'group' }" @click="tab = 'group'">
              그룹 신청
            </button>
          </li>
          <li class="ms-auto nav-item">
            <button class="btn btn-sm btn-outline-secondary" :disabled="loading" @click="loadAll">
              새로고침
            </button>
          </li>
        </ul>
            ...
            >
              <div class="d-flex align-items-center gap-3">
                ...
                <div class="room-texts">
                  <div class="room-title">
                    ...
                    <span class="status" :class="(w.rstatus || 'P').toUpperCase() === 'A' ? 'ok' : ((w.rstatus || 'P').toUpperCase() === 'R' ? 'rej' : 'pend')">
                      {{ statusLabel(w.rstatus) }}
                    </span>
                  </div>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <template v-else>
                  ...
                  >
                    {{ (w.rstatus || 'P').toUpperCase() === 'A' ? '수락됨' : '거절됨' }}
                  </span>
                </template>
...
/** 상대 메타 로딩 (ChatList와 동일 컨셉: 첫 펫 기준) */
...
async function enrichMetaForLists() {
  ...
  const all = [...new Set([...oppReceived, ...oppSent])]
